...
public class ProfilePictureResourceIT {
  ...
  @Autowired private ProfilePicture profilePicture;
  ...
  public void setup() {
    ...
    final ProfilePictureResource profilePictureResource =
        new ProfilePictureResource(profilePictureRepository, userRepository, pictureService);
    this.restProfilePictureMockMvc =
        MockMvcBuilders.standaloneSetup(profilePictureResource)
  ...
  public void getAllProfilePictures() throws Exception {
    ...
    restProfilePictureMockMvc
        .perform(get("/api/profile-pictures?sort=id,desc"))
  ...
  public void getProfilePicture() throws Exception {
    ...
    restProfilePictureMockMvc
        .perform(get("/api/profile-pictures/{id}", profilePicture.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingProfilePicture() throws Exception {
    // Get the profilePicture
    restProfilePictureMockMvc
        .perform(get("/api/profile-pictures/{id}", Long.MAX_VALUE))
  ...
  public void updateProfilePicture() throws Exception {
    ...
    ProfilePicture updatedProfilePicture =
        profilePictureRepository.findById(profilePicture.getId()).get();
    // Disconnect from session so that the updates on updatedProfilePicture are not directly saved
    // in db
  ...
  public void deleteProfilePicture() throws Exception {
    ...
    restProfilePictureMockMvc
        .perform(
            delete("/api/profile-pictures/{id}", profilePicture.getId())
