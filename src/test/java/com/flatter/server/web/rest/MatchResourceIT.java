...
public class MatchResourceIT {
    ...
    public void createMatch() throws Exception {
        ...
        assertThat(testMatch.isIsApproved()).isEqualTo(DEFAULT_IS_APPROVED);
        assertThat(testMatch.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testMatch.getApprovalDate()).isEqualTo(DEFAULT_APPROVAL_DATE);
    }
    ...
    public void updateMatch() throws Exception {
        ...
        Match testMatch = matchList.get(matchList.size() - 1);
        assertThat(testMatch.isIsApproved()).isEqualTo(UPDATED_IS_APPROVED);
        assertThat(testMatch.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testMatch.getApprovalDate()).isEqualTo(UPDATED_APPROVAL_DATE);
    }
